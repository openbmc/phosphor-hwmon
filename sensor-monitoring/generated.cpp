...
static Group fan_zone_group = {
    std::make_tuple(
        "/xyz/openbmc_project/sensors/fan_tach/fan0",(0ll)
    ),
    std::make_tuple(
        "/xyz/openbmc_project/sensors/fan_tach/fan1",(0ll)
    ),
    std::make_tuple(
        "/xyz/openbmc_project/sensors/fan_tach/fan2",(0ll)
    ),
    std::make_tuple(
        "/xyz/openbmc_project/sensors/fan_tach/fan3",(0ll)
    )
};
