...
class MainLoop
{
  public:
    ...
    /** @brief Set average value in averageSet based on sensor key
     *  This function will be called only when the env AVERAGE_xxx is set to
     *  ture.
     *
     *  @param[in] sensorKey - Sensor details
    ...
    /** @brief Handle the average value
     *
     *  @param[in] sensorKey - The averageKey
     *  @param[in] curValue - Current average value of power*_average
     *
     *  @ return value - New calculated average value
     */
    std::optional<int64_t> handleAverage(const averageKey& sensorKey,
