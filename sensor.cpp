                                              ...
                                              ObjectInfo& info)
{
    ...
    if (statusIface->functional())
    {
        ...
        {
            // Catch the exception here and do not let it propagate it up the
            // stack and exit on failure. Update the functional property.
            // This means we will skip the "Remove RCs" check in MainLoop if
            // it was waiting to catch a system_error from the IO read failure.
