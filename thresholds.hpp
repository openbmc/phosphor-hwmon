 ...
 *  @param[in] path - The dbus object path on which to attach the interface.
 *  @param[in] o - The dbus object on which to attach the interface.
 *  @param[in] value - The sensor reading.
 *  @param[in] env - The sensor configuration.
 */
template <typename T>
